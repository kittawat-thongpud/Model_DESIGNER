...
import type {
  ...
  ArchFamily, TrainingProfile, TrainingConfigField,
} from '../types';
...
export const api = {
  ...
  getArchConfigFields: (pluginName: string) => get<TrainingConfigField[]>(`/api/plugins/archs/${pluginName}/config-fields`),
