...
_HSG_DETR_MODULES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "args": [
            ...
            {"name": "channel_se", "type": "bool", "default": False,
             "help": "Enable V2c squeeze-excitation gate on sparse attention deltas"},
            {"name": "se_reduction", "type": "int", "default": 4,
             "help": "Reduction ratio for the V2c channel-selective SE gate"},
        ],
        "source": "hsg_detr",
    },
    {
