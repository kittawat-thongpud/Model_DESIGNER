    ...
    *,
    ...
    if not ds_dir.exists():
        ...
        if not data_yaml.exists():
            # data.yaml will be auto-generated by the training worker — warn only
            result.warn(
                f"Dataset '{dataset_name}' has no data.yaml yet. "
                "It will be generated automatically when training starts."
            )
